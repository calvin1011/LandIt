...
def load_clean_training_data():
    ...
    training_files = [
        ...
        "business_experience_training_data.json",
        "business_skills_training_data.json",
        "health_experience_training_data.json",
        "health_skills_training_data.json",
        "misc_experience_training_data.json",
        "misc_skills_training_data.json",
        "retail_cs_experience_training_data.json",
        "retail_cs_skills_training_data.json",
        "tech_experience_training_data.json",
        "tech_skills_training_data.json",
        "trades_labor_experience_training_data.json",
        "trades_labor_skills_training_data.json",
